        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            >
              <div className="h-full w-full bg-black bg-opacity-60 flex items-center justify-center">
                <svg className="w-10 h-10" style={{ filter: "drop-shadow(0px 0px 5px rgba(212, 175, 55, 0.5))" }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="p-6">
              ...
              <Link href="/horoscope" className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[#d4af37] to-[#b8860b] hover:from-[#b8860b] hover:to-[#d4af37] font-semibold transition-all">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="p-6">
              ...
              <Link href="/numerology" className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[#d4af37] to-[#b8860b] hover:from-[#b8860b] hover:to-[#d4af37] font-semibold transition-all">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="p-6">
              ...
              <Link href="/premium" className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[#d4af37] to-[#b8860b] hover:from-[#b8860b] hover:to-[#d4af37] font-semibold transition-all">
